...
This workflow helps you pull streams, spot the moments worth clipping, edit faster, remap subtitles to your cut, and translate them for viewers in other languages, so your oshi's words can travel further with love, passion, and efficiency.
...
Steps 2 and 5 use an AI agent to find clip-worthy moments and handle translation. This README uses **Claude Code** as the example.
...
└─────────────────────────┘
    ...
    ▼
┌─────────────────────────┐
│ Step 2: Find clip-worthy │  ytclip-2-highlight-moments (AI)
│         moments          │
└─────────────────────────┘
...
Start by making a folder for this clip project:
...
## Step 2 — Find Clip-Worthy Moments (AI)

This is a two-part pass: first a script chunks the transcript, then an AI agent scores which moments feel strongest for a fanmade clip.
...
> Read `~/my-video/chunks.json` and identify the top 10-20 clip-worthy moments for a fanmade VTuber highlight following the rubric in `ytclip-2-highlight-moments/references/highlight-evaluation-rubric.md`. Save the output as `~/my-video/highlight-moments.md`.
